...
// Zones: rings 1 (top) → 5 (bottom), 9 pockets each = 45 plants.
// The tower's top opening is the worm-column access, not a planting spot.
export const ZONES = [
  {id:'r1', name:'Ring 1 · Top', slots:9, sun:'Full — most direct', water:'Dries fastest', nutri:'Light',
   desc:'Top ring of pockets — the most sun, the fastest to dry out. Heat-lovers, Mediterranean herbs, and strawberries are happiest here.'},
...
export const PLANTS = [
  {id:'tom_bush', name:'Tomato (patio/bush)', season:'warm', best:['r1'], good:['r2'], form:'fruit', foliage:'#4E7A3C', accent:'#D2452B', note:'Determinate/patio types up top; stake lightly.', care:'Full sun, even water. Feed monthly; pinch suckers on semi-determinate types.'},
  ...
  {id:'pepper', name:'Pepper (bell / chili)', season:'warm', best:['r1'], good:['r2'], form:'fruit', foliage:'#3F6B31', accent:'#C9401A', note:'Loves the hot, bright top.', care:'Let soil dry slightly between waterings. Harvest often to keep it producing.'},
  ...
  {id:'basil', name:'Basil', season:'warm', best:['r1'], good:['r2'], form:'herb', foliage:'#3F7A2E', note:'Sun + warmth = flavor.', care:'Pinch flower spikes to keep leaves coming. Loves July.'},
  ...
  {id:'thyme', name:'Thyme', season:'all', best:['r1','r2'], good:[], form:'herb', foliage:'#6E8A5E', small:true, note:'Likes the fast-drying top rows.', care:'Thrives on light neglect. Trim to keep it bushy.'},
  {id:'oregano', name:'Oregano', season:'all', best:['r1','r2'], good:[], form:'herb', foliage:'#5E7A50', small:true, note:'Drought-tolerant upper-row herb.', care:'Cascades nicely from a pocket. Cut back hard in spring.'},
  {id:'rosemary', name:'Rosemary (compact)', season:'all', best:['r1'], good:[], form:'spiky', foliage:'#3A5A44', note:'Dry, sunny top spot.', care:'Water least of anything in the tower. Compact/trailing varieties only.'},
...
export const ZLABEL = {r1:'Ring 1 (top)', r2:'Ring 2 (upper)', r3:'Ring 3 (middle)', r4:'Ring 4 (lower)', r5:'Ring 5 (bottom)'};
export const ZSHORT = {r1:'R1', r2:'R2', r3:'R3', r4:'R4', r5:'R5'};
